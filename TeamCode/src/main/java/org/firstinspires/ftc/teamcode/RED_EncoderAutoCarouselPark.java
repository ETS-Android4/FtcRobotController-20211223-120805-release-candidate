...
@Autonomous(name = "RED_EncoderAutoCarouselPark")

public class RED_EncoderAutoCarouselPark extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //codes here
        moveBackward(1.0);
        spinCarousel(DcMotorEx.Direction.FORWARD, 0.5, 3000);
        leftStrafe(1.0);
